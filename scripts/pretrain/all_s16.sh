...
do
    ...
    python -u /mnt/petrelfs/chengdawei/lustre/aLLM4TS/run_LLM4TS.py \
    --is_training 1 \
    ...
    > /mnt/petrelfs/chengdawei/lustre/aLLM4TS/logs/pt_patch/$pt_data/$model_id'_sl'$seq_len'_llml'$llm_layers'_lr'$lr'_bs'$bs'_'$exp_des.log 2>&1
done
done
done
done
